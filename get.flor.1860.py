...
ifiles = '/tigress/wenchang/MODEL_OUT/CTL1860_noleap_tigercpu_intelmpi_18_576PE/POSTP/????0101.atmos_daily.nc'
ifile = ifiles.replace('????', '0001')
data_name = "precip"
ofile = f'CTL1860_noleap_tigercpu_intelmpi_18_576PE.atmos_daily.{data_name}.nc'
xname = 'grid_xt'
xlim = (70, 80)
yname = 'grid_yt'
ylim = (5, 15)
