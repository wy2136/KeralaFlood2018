...
ifiles = '/tigress/wenchang/MODEL_OUT/cesm1_2_1/BCN_f05g16_tigercpu_intelmpi18_512PE/atm/hist/BCN_f05g16_tigercpu_intelmpi18_512PE.cam.h1.????-01-01-00000.nc'
data_name = "PRECT"
ofile = f'BCN_f05g16_tigercpu_intelmpi18_512PE.cam.h1.{data_name}.nc'
xname = 'lon'
xlim = (70, 80)
yname = 'lat'
ylim = (5, 15)
