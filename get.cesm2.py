...
ifiles = '/tigress/wenchang/MODEL_OUT/cesm2_0/b.e20.B1850.f09_g17.tigercpu_intelmpi_18_540PE/atm/hist/b.e20.B1850.f09_g17.tigercpu_intelmpi_18_540PE.cam.h1.????-01-01-00000.nc'
data_name = "PRECT"
#ofile = f'B1850CN_f05g16_tigercpu_intelmpi18_512PE.cam.h1.{data_name}.nc'
ofile = f'b.e20.B1850.f09_g17.tigercpu_intelmpi_18_540PE.cam.h1.{data_name}.nc'
xname = 'lon'
xlim = (70, 80)
yname = 'lat'
ylim = (5, 15)
